...
default['elasticsearch']['base_dir'] = '/vol/elasticsearch'
default['elasticsearch']['conf_dir'] = "#{node['elasticsearch']['base_dir']}/conf"
default['elasticsearch']['data_dir'] = "#{node['elasticsearch']['base_dir']}/data"
default['elasticsearch']['log_dir'] = "#{node['elasticsearch']['base_dir']}/logs"
default['elasticsearch']['pid_path'] = "#{node['elasticsearch']['base_dir']}/var/run"
default['elasticsearch']['plugin_dir'] = "#{node['elasticsearch']['base_dir']}/elasticsearch-#{node['elasticsearch']['version']}/plugins"

default['elasticsearch']['tss'] = "256k"
